...
class Activator
{
    ...
    public static function activate()
    {
        ...
        array_push($args['repositorios'],array('id'=>uniqid(), 'name' => 'sedici',
            'domain' => 'sedici.unlp.edu.ar','support'=>true,'protocol'=>'http','subtype' =>'sedici.subtype:','handle'=>'scope','author'=>'author:','subject'=>'subject:','degree'=>'thesis.degree.name','base_path'=>'/open-search/discover','format' => 'atom','query'=>'query','default_query'=>"")
        );
